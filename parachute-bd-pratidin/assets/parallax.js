...
* @license MIT
* @description Parallax by PurplePatch
...
// }else{
// 	document.querySelector(".parallax.bg1").style.backgroundImage="url('//ms.purplepatch.online/test/parallax/bd-pratidin/march/assets/2.jpg')";
